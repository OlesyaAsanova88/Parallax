...
new Parallax(document.getElementById('scene11'));
new Parallax(document.getElementById('scene12'));
new Parallax(document.getElementById('scene13'));

new Parallax(document.getElementById('last-image'));
